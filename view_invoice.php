                   ...
                   <!-- Begin Page Content -->
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Table -->
                            ...
                            if ($status == "Partially Returned" || $status == "Fully Returned"){
                              ?>
                            <div class="col-lg-12">
                                <form method="post" class="navbar-expand col-lg-12">
                                <header class="card-header font-weight-bold">Return History</header>
                                <div class="d-sm-flex align-items-center justify-content-between mb-4" style="padding-top: 0;">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                      <thead>
                                        <tr>
                                      ...
                                      <tbody>
                                        <?php
                                          $viewDetails = "SELECT * FROM auditreturns WHERE invoiceNum = " . $_SESSION['invoiceNum'];
                                            $result2 = $con->query($viewDetails);
                                            if ($result2->num_rows > 0) {
                                            // output data of each row
                                            while($row = $result2->fetch_assoc()) {
                                                ...
                                                echo "\t<tr><td >" . $row['Date'] . "</td><td>" . $row['ProdCode'] . "</td><td>"  .  $row['Quantity'] . "</td></tr>\n";
                                                }

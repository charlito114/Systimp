                    ...
                    <div class="container-fluid">
                        ...
                        <form method = "post" action = "" style="margin-top: 70px; border-top:  .10rem solid #b4c540;">
                            ...
                            <div class="d-flex" style=" margin-top: 10px;">
                                ...
                                <div style="width: 20%;">
                                  <button type = 'submit' name = 'submit'  value = 'submit' formaction = 'processUpdate.php' class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm" style="width: 100px;float: left;"> Submit </button>
...
while($row = $search_result->fetch_assoc()) {
    ...
    <form method = "post" action = "" style="margin-top: 70px; border-top:  .10rem solid #b4c540;">
                            ...
                            <div class="d-flex" style=" margin-top: 10px;">
                                <div style="width: 80%; float: left;"></div>
                                <div style="width: 20%;">
                                  <button type = 'submit' name = 'submit'  value = 'submit' formaction = 'processcancel.php' class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm" style="width: 100px;float: left;"> Submit </button>

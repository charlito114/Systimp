...
<link href="https://fonts.googleapis.com/css?family=Nunito:200,200ni,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
            ...
            <form action = "" method= "post">
                <div class="col-lg-12">
                    ...
                    <div class="d-flex" style=" margin-top: 10px;">
                        ...
                        <button name = "add" value = "add" formaction = "p_inventory_add_product.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="width: 100px; float: right;"> Add </button>
                    </div>
                    ...
                    <div class="col-lg-12">
                            ...
                            <form method="post"> 
                                <div class="d-flex" style=" margin-top: 10px;">
                                    ...
                                    <!-- Submit Button-->
                                    <button type = 'submit' name = 'submit'  value = 'submit' formaction = 'p_insert.php'  class="d-flex d-sm-inline-block btn btn-sm btn-success shadow-sm" style="width: 35%; float: left; margin-right: 20%;"> Submit </button>
                                    <!-- Cancel Button-->
                                    <button type = 'submit' name = 'back'  value = 'back' formaction = 'p_inventory_add_product.php'  class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm" style="width: 35%; float: right;"> Cancel </button>
                                    </div>
                                </div>
                            </form>
                            </div>

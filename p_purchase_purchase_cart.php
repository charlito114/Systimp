...
<!-- COPY END -->
                       ...
                       if(isset($_POST['add']))
                        {
                          ...
                          while($row = $search_result->fetch_assoc()) {
                            ...
                            ?>  
                        <form method = "post" action = "p_purchase_purchase_cart.php" style="width: 100%;">
                    ...
                    echo "0 results";
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4" style="padding-top: 0; border-top: .20rem solid #b4c540;">
                            <form method="post" action="p_purchase_purchase_cart.php">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                  <thead>
                                    <tr>
                                      <th>Product Code</th>
                            ...
                            <?php 
                                ...
                                if(mysqli_query($con,$deleteQuery)){
                                    header("location:p_purchase_purchase_cart.php");
                                        }
                                else{
                                    header("location:p_purchase_purchase_cart.php");
                                        }
                            ...
                            <div class="d-flex" style=" margin-top: 10px;">
                                ...
                                <!-- Create PO Button-->
                                <a href = "p_purchase_add_purchase_order.php">

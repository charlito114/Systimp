                        ...
                        <!-- Table -->
                            ...
                            <form method="post"> 
                                <div class="d-flex" style=" margin-top: 10px;">
                                    ...
                                    <!-- Submit Button-->
                                    <button type = 'submit' name = 'submit'  value = 'submit' formaction = 'p_processOrder2.php' class="d-flex d-sm-inline-block btn btn-sm btn-success shadow-sm" style="width: 35%; float: left; margin-right: 20%;"> Submit </button>
                                    <!-- Cancel Button-->
                            ...
                            <?php
                                ...
                                if(isset($_POST['remove'])){
                                    ...
                                    if(mysqli_query($con,$deleteQuery)){
                                        header("location:p_order_add_order.php");
                                            }
                                    else{
                                        header("location:p_order_add_order.php");
                                            }
                                ...
                                if(isset($_POST['back'])){
                                    ...
                                    if(mysqli_query($con,$refreshQuery)){
                                        header("location:p_order_sales_orders.php");
                                        session_unset(); 
                                        session_destroy();

            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg topbar mb-4 static-top shadow">
                        <div class="sidebar-brand-text mx-3" style="color:white; font-size: 30px;">Manage Sales Orders</div>
...
<!-- COPY END -->
                    ...
                    <div class="card-body mb-4">
                        ...
                        <div class="table-responsive">
                            <form method = 'post' action = 'view_pending_so.php'>
                                  ...
                                  <tbody>
                                    <?php 
                                      if ($search_result->num_rows > 0) {
                                        ...
                                        while($row = $search_result->fetch_assoc()) {
                                            echo "\t<tr><td >" . $row['Date'] . "</td><td><input type = 'submit' name = 'SONum' value = '" . $row['SONum'] . "' class = 'btn' style = 'color: #4e73df;'> </td><td>"  .  $row['CustomerName'] . "</td><td>" . $row['totalItems'] ."</td><td>" . $row['pendingItems'] ."</td><td>" . $row['completion'] ."</td></tr>\n";

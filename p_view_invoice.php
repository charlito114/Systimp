                        ...
                        <!-- Table -->
                            ...
                            <form method="post"> 
                                <div class="d-flex" style=" margin-top: 10px;">
                                    ...
                                    <!-- Cancel Button-->
                                    <button type = 'submit' name = 'back'  value = 'back' formaction =  'p_sales_sales_list.php' class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm" style="width: 100px; float: right;"> Back </button>
                                    </div>
                                </div>
                            </form>
                            </div>
